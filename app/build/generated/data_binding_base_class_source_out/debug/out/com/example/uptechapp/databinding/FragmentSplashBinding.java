...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout fragmentSplash;

  @NonNull
  public final TextView textView;

  private FragmentSplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout fragmentSplash, @NonNull TextView textView) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout fragmentSplash = (ConstraintLayout) rootView;
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, fragmentSplash, textView);
    }
