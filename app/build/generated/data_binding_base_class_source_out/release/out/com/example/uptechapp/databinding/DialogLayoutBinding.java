...
public final class DialogLayoutBinding implements ViewBinding {
  ...
  private DialogLayoutBinding(@NonNull ConstraintLayout rootView, @NonNull TextView dialogText,
  ...
  public static DialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLayoutBinding((ConstraintLayout) rootView, dialogText, progressBar);
    }
